...
const framework = { type: "string", enum: ["claude", "codex", "opencode", "cursor", "windsurf", "zed"] };
export const INTEGRATION_APP_COMMANDS = {
  ...
  install_integration: command("Start installing the local app MCP entry into a supported client configuration. Poll get_integrations for the result.", { framework: { type: "string", enum: ["claude", "codex", "opencode", "cursor", "windsurf", "zed"] } }, ["framework"]),
